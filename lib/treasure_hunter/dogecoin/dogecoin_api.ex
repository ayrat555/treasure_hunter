defmodule TreasureHunter.Dogecoin.DogecoinAPI do
  ...
  @base_url "https://dogechain.info/api/v1/address/received/"
  ...
  defp fetch_balance_and_txs(%{parse_body: json}, _) do
    case json do
      %{
        "received" => string_balance,
        "success" => 1
      } ->
        {balance, _} = Float.parse(string_balance)
        result = %{tx_count: nil, balance: balance}
